%%% Here is a code written by me in MATLAB
%%% To calculate the training accuracy of ML classifiers

function [cm, accuracy] = knnFun_train(X, Y, cv,Num_Nei)

%% Classifier

CVKNNModel = fitcknn(X,Y,'Holdout',cv,'NumNeighbors',Num_Nei); % use fitcsvm, fitcecoc or others
