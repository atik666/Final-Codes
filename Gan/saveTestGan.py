...
# load model
model = load_model(r'D:\Atik\pythonScripts\WCNN\vibImages\innerFig\generator_model_0.h5')
...
for i in range(0,len(vector)):
    ...
    pyplot.axis('off')
    pyplot.savefig(
        "D:/Atik/pythonScripts/WCNN/vibImages/innerFig/0/Fake/fakeFig_%d.png" % (i+1),
